...
const Help = () => {
    return (<>
        <div className="main-help">
            <p>This site features a terminal-inspired interface, simulating a <a className="a-cl" href="https://en.wikipedia.org/wiki/Command-line_interface">command-line</a> environment for navigating and interacting with files. Essential commands include:
